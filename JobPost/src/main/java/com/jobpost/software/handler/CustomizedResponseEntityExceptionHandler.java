package com.jobpost.software.handler;
...
import com.stock.Exeception.ExceptionResponse;
...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler{
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(
		...
		ExceptionResponse e = new ExceptionResponse(new Date(),"Vailedation Failed",ex.getBindingResult().toString());
